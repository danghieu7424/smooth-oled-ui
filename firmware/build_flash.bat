...
"%CLI_PATH:"=%" compile -v --fqbn esp32:esp32:esp32s3:FlashMode=qio,FlashSize=16M,PartitionScheme=app3M_fat9M_16MB,PSRAM=disabled,CDCOnBoot=cdc --build-path "%BUILD_DIR%" firmware.ino
